Buatlah komponen Data Grid untuk manajemen Supplier dengan spesifikasi:

1. Tampilkan tabel dengan kolom:
   - "Nama Supplier" (bisa di-sort, header dengan panah ↓)
   - ["Nama Supplier", "Kontak", "Telepon", "Aksi"]
...
- Di atas tabel, buat sebuah header yang berisi:
  - Judul "Supplier" di sebelah kiri
  - Tombol "+ Tambah Supplier" di sebelah kanan
