...
export const AppDownload: React.FC = () => {
    return (
        <section className="bg-gradient-to-br from-[#E4D5B7] to-[#D4B896] py-8">
            <div className="container mx-auto px-4">
                <div className="max-w-2xl mx-auto text-center">
                    <h3 className="text-2xl font-bold text-[#3E2723] mb-2">
                        Gunakan Aplikasi Pawon
                    </h3>
                    <p className="text-[#4E342E] mb-6">
                        Download aplikasi untuk pengalaman belanja yang lebih baik
                    </p>
